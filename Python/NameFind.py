...
def DetectEyes(Cascade1, Cascade2, Image):
    ...
    faces = Cascade2.detectMultiScale(Image, 1.3, 5)  # Detect the faces and store the positions

    for (x, y, w, h) in faces:  # Frames  LOCATION X, Y  WIDTH, HEIGHT
        FaceImage = Image[y - int(h / 2): y + int(h * 1.5),
        ...
        for (sx, sy, sw, sh) in glass:
            ...
            # ---------- IF THERE ARE TWO EYES THE FACE CAN BE ROTATED, IF NOT, NO ROTATION IS DONE BUT THE FACE IS
            ...
            if glass.shape[0] == 2:  # The Image should have 2 eyes
                ...
                DY = (
                (glass[1][1] + glass[1][3] / 2) - (glass[0][1] + glass[0][3] / 2))  # Height diffrence between the glass
                DX = (
                (glass[1][0] + glass[1][2] / 2) - glass[0][0] + (glass[0][2] / 2))  # Width diffrance between the glass
